 ...
 */
public class Borrar_Empleados extends javax.swing.JFrame {

    /**
     * Creates new form Borrar_Empleados
     */
    ...
    private void initComponents() {
        ...
        BBCedula = new javax.swing.JTextField();
        BBuscar = new javax.swing.JButton();
        Todo = new javax.swing.JButton();
        BorrarEm = new javax.swing.JButton();
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 620, 240));
        ...
        getContentPane().add(BBCedula, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 40, 120, -1));
        ...
        getContentPane().add(BBuscar, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 350, -1, -1));
        ...
        getContentPane().add(Todo, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 350, -1, -1));

        BorrarEm.setText("Eliminar");
        BorrarEm.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BorrarEmActionPerformed(evt);
            }
        });
        getContentPane().add(BorrarEm, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 350, -1, -1));
    ...
    private void BBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BBuscarActionPerformed
        try {
            Listarempleados("select * from tbl_empleado where IDE="+Integer.parseInt(this.BBCedula.getText())+";");
    ...
    private void BorrarEmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BorrarEmActionPerformed
        AccesoBD BD = new AccesoBD();        
        try {
            BD.Establecer_conexion();
            BD.actualizarBD("delete from tbl_empleado where IDE = "+Integer.parseInt(BBCedula.getText())+";");
            Listarempleados("select * from tbl_empleado;");
            BD.CerrarBD();
        } catch (SQLException ex) {
            Logger.getLogger(Borrar_Empleados.class.getName()).log(Level.SEVERE, null, ex);
        }
    }//GEN-LAST:event_BorrarEmActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Borrar_Empleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    private javax.swing.JTextField BBCedula;
    private javax.swing.JButton BBuscar;
    private javax.swing.JButton BorrarEm;
